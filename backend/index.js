...
mongoose
  .connect(
    "mongodb+srv://Sanketh:170404@cluster0.hrdp4wn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    {
...
app.post("/checkout", fetchuser, async (req, res) => {
  ...
  try {
    ...
    // const validItemIds = Object.keys(cartData).filter(
    ...
    if (items.length === 0) {
      return res
        .status(400)
        .json({ success: false, message: "No valid items found in the cart" });
    }
